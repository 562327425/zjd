...
public class Hdinfo implements java.io.Serializable {
	...
	@Column(name = "hdname", nullable = true, length = 20)
	...
	@Column(name = "yidengjiang", nullable = true, length = 20)
	...
	@Column(name = "yicount", nullable = true)
	...
	@Column(name = "yizhongjiang", nullable = true, length = 20)
	...
	@Column(name = "erdengjiang", nullable = true, length = 20)
	...
	@Column(name = "ercount", nullable = true)
	...
	@Column(name = "erzhongjiang", nullable = true, length = 20)
	...
	@Column(name = "sandengjiang", nullable = true, length = 20)
	...
	@Column(name = "sancount", nullable = true)
	...
	@Column(name = "sanzhongjiang", nullable = true, length = 20)
